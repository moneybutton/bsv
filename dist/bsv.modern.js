      ...
      switch (opCodeNum) {
        ...
        case OpCode.OP_16:
          {
            ...
            this.stack.push(_buf); // The result of these opCodes should always be the minimal way to push the data
        ...
        case OpCode.OP_EQUALVERIFY:
          // case OpCode.OP_NOTEQUAL: // use OpCode.OP_NUMNOTEQUAL
          {
            ...
            let fEqual = cmp(_buf15, _buf16); // OpCode.OP_NOTEQUAL is disabled because it would be too easy to say
        ...
        case OpCode.OP_HASH256:
          {
            ...
            let _buf18 = this.stack[this.stack.length - 1]; // valtype vchnew Hash((opCode == OpCode.OP_RIPEMD160 || opCode == OpCode.OP_SHA1 || opCode == OpCode.OP_HASH160) ? 20 : 32)
