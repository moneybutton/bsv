...
Interp.prototype.step = function() {
  ...
  switch (opcodenum)
  {
    ...
    {
      if (flags & Interp.SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS)
    ...
    case Opcode.map.OP_WITHIN:
    {
      ...
      var b1 = BN().fromCScriptNumBuffer(this.stack[this.stack.length - 3], fRequireMinimal);
      var b2 = BN().fromCScriptNumBuffer(this.stack[this.stack.length - 2], fRequireMinimal);
      var b3 = BN().fromCScriptNumBuffer(this.stack[this.stack.length - 1], fRequireMinimal);
    ...
    case Opcode.map.OP_CHECKMULTISIGVERIFY:
    {
      ...
      var nSigsCount = BN().fromCScriptNumBuffer(this.stack[this.stack.length - 1], fRequireMinimal).toNumber();
      ...
      if ((flags & Interp.SCRIPT_VERIFY_NULLDUMMY) && this.stack[this.stack.length - 1].length) {
