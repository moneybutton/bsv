...
function inject(deps) {
  ...
  function Interp(script, tx, stack, altstack, pc, pbegincodehash, nOpCount, ifstack, errstr, flags) {
    if (!(this instanceof Interp))
      return new Interp(script, tx, stack, altstack, pc, pbegincodehash, nOpCount, ifstack, errstr, flags);
    this.initialize();
    this.fromObject({
      script: script,
      tx: tx,
