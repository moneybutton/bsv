 ...
 * components of YoursBitcoin because of the giant switch statement in step(). But
...
/**
    ...
    * results (scriptSig, scriptPubKey, tx, nIn, flags) {
    ...
    getDebugObject () {
      ...
      return {
        errStr: this.errStr,
        scriptStr: this.script.toString(),
        pc: pc,
        opCodeStr: OpCode.fromNumber(this.script.chunks[pc].opCodeNum).toString()
      }
    }
