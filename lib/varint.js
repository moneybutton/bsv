...
Varint.prototype.fromBufR = function(br) {
  this.buf = br.readVarintBuf();
  return this;
};

Varint.prototype.fromBN = function(bn) {
  this.buf = BufW().writeVarintBN(bn).concat();
  return this;
};

Varint.prototype.fromNumber = function(num) {
  this.buf = BufW().writeVarintNum(num).concat();
  return this;
};
...
Varint.prototype.toBN = function() {
  return BufR(this.buf).readVarintBN();
};

Varint.prototype.toNumber = function() {
  return BufR(this.buf).readVarintNum();
};
