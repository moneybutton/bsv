 ...
 *
 * const mnemonic = new Mnemonic().fromRandom().toString()
 *
 * or from a known mnemonic:
 *
 * const seed = new Mnemonic().fromString(mnemonic).toSeed()
 */
'use strict'
...
import { wordList } from './mnemonic/bip-39-en-wordlist'
import { Workers } from './workers'

class Mnemonic extends Struct {
  ...
  async asyncFromRandom(bits) {
    ...
    const bip39 = new Mnemonic().fromFastBuffer(workersResult.resbuf)
