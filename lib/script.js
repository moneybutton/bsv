...
let inject = function (deps) {
  ...
  */
  ...
  Script.prototype.isScripthashIn = function () {
    ...
    try {
      Script().fromBuffer(this.chunks[this.chunks.length - 1].buf)
    } catch (err) {
      return false
    }
    return true
  ...
  Script.prototype.isScripthashMultisigIn = function () {
    ...
    let redeemScript
    try {
      redeemScript = Script().fromBuffer(this.chunks[this.chunks.length - 1].buf)
    } catch (err) {
      return false
    }
  ...
  Script.prototype.setChunkBN = function (i, bn) {
    this.chunks[i] = Script().writeBN(bn).chunks[0]
    return this
  }
  ...
  Script.prototype.setChunkBuffer = function (i, buf) {
    this.chunks[i] = Script().writeBuffer(buf).chunks[0]
    return this
  }
