...
Script.prototype.isOpReturn = function() {
  if (this.chunks[0].opcodenum === Opcode.map.OP_RETURN
    &&
...
Script.prototype.isPubkeyhashOut = function() {
  if (this.chunks[0] && this.chunks[0].opcodenum === Opcode.map.OP_DUP
    && this.chunks[1] && this.chunks[1].opcodenum === Opcode.map.OP_HASH160
    && this.chunks[2].buf
    && this.chunks[3] && this.chunks[3].opcodenum === Opcode.map.OP_EQUALVERIFY
    && this.chunks[4] && this.chunks[4].opcodenum === Opcode.map.OP_CHECKSIG) {
    return true;
  } else {
    return false;
  }
