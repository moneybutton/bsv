...
let inject = function (deps) {
  ...
  /* If this flag set, txin.seqnum is NOT interpreted as a relative lock-time.
   * */
  Txin.SEQUENCE_LOCKTIME_DISABLE_FLAG = (1 << 31)

  /* If txin.seqnum encodes a relative lock-time and this flag is set, the
  ...
  /* If txin.seqnum encodes a relative lock-time, this mask is applied to
