...
/**
 * Will return child PrivateKey derived from id by IBE.
 *
 * @returns {PrivateKey} A new valid instance of IBE child PrivateKey
 */
PrivateKey.prototype.childKey = function (id) {
  var idbuf = Buffer.from(id)
  var pubkey = this.toPublicKey()
  var hash = Hash.sha512hmac(Buffer.from(id), Buffer.from(pubkey.toString()))
  var leftpart = BN.fromBuffer(hash.slice(0, 32))
  var newPrivateKey = leftpart.add(this.bn).umod(Point.getN()).toBuffer({size: 32})
