...
let inject = function (deps) {
  ...
  class Tx extends Struct {
    constructor (versionBytesNum, txInsVi, txIns, txOutsVi, txOuts, nLockTime) {
      super()
      this.initialize()
      this.fromObject({versionBytesNum, txInsVi, txIns, txOutsVi, txOuts, nLockTime})
    }
    ...
    sighash (nHashType, nIn, subScript) {
      let txcopy = Tx.fromBuffer(this.toBuffer())
