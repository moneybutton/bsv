...
ECIES.prototype.initialized = async function() {
...
cachedProperty('kEkM', async function () {
  return this._kEkM
})
...
ECIES.prototype.encrypt = async function (message, ivbuf) {
  ...
  var d = await Hash.sha256hmac(c, this.kM)
...
ECIES.prototype.decrypt = async function (encbuf) {
  $.checkArgument(encbuf)
  var offset = 0
  var tagLength = 32
  ...
  var d2 = await Hash.sha256hmac(c, this.kM)
