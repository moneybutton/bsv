...
let inject = function (deps) {
  ...
  BIP32.prototype.asyncFromString = function (str) {
    return asink(function *() {
      let args = [str]
      let workersResult = yield Workers.asyncMethod(this, 'fromString', args)
      let bip32 = BIP32().fromFastBuffer(workersResult.resbuf)
  ...
  BIP32.prototype.asyncToString = function () {
    return asink(function *() {
      let workersResult = yield Workers.asyncMethod(this, 'toString', arguments)
