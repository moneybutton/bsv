...
function inject(deps) {
  ...
  BIP32.prototype = Object.create(deps.Struct.prototype);
...
let BIP32 = injector(inject, dependencies);
BIP32.Mainnet = injector(inject, dependencies, {
  Privkey: require('./privkey').Mainnet,
  Constants: require('./constants').Mainnet.BIP32
});
BIP32.Testnet = injector(inject, dependencies, {
