...
function inject(deps) {
  ...
  BIP32.inject = inject;
  BIP32.prototype = Object.create(injected.Struct.prototype);
  BIP32.prototype.constructor = BIP32;

  BIP32.prototype.fromRandom = function() {
    let Constants = injected.Constants;
    let Random = injected.Random;
    let Privkey = injected.Privkey;
    let Pubkey = injected.Pubkey;
