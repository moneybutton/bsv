...
function inject(deps) {
  ...
  BIP32.inject = inject;
  BIP32.prototype = deps && deps.Struct ? Object.create(deps.Struct.prototype)
  ...
  BIP32.prototype.fromRandom = function() {
    ...
    let Privkey = this.constructor.Privkey;
    let Pubkey = this.constructor.Pubkey;
  ...
  BIP32.prototype.toPublic = function() {
    let Constants = this.constructor.Constants;
    this.version = Constants.pubkey;
    this.privkey = undefined;
    return this;
  };

  BIP32.prototype.toBuffer = function() {
    let BW = this.constructor.BW;
    let Constants = this.constructor.Constants;
    let isPrivate = this.version === Constants.privkey;
    let isPublic = this.version === Constants.pubkey;
    if (isPrivate) {
