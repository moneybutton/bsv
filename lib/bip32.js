...
BIP32.prototype.buildxpubkey = function() {
  ...
  versionbuf.writeUInt32BE(this.version, 0);
  var childindexbuf = new Buffer(4);
  childindexbuf.writeUInt32BE(this.childindex, 0);
...
BIP32.prototype.toBuffer = function() {
  if (this.isPrivate())
    return this.buildxprivkey();
  else if (this.isPublic())
    return this.buildxpubkey();
  else
