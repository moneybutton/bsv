...
let inject = function (deps) {
  ...
  Sig.prototype.hasLowS = function () {
    if (this.s.lt(1) || this.s.gt(new Bn().fromBuffer(new Buffer('7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B20A0', 'hex')))) {
      return false
    }
    return true
  }
