...
ECDSA.prototype.deterministicK = function() {
  var v = new Buffer(32);
  v.fill(0x01);
  var k = new Buffer(32);
  k.fill(0x00);
...
ECDSA.prototype.sign = function() {
  ...
  if (r.cmp(0) <= 0 || s.cmp(0) <= 0)
    throw new Error('invalid choice of k - try randomK()');
  //TODO: Finish deterministicK algorithm to suppor this case rather than throwing an error
