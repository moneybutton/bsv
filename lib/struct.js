...
let inject = function (deps) {
   ...
   */
  Struct.prototype.genFromBuffers = function *() {
    throw new Error('not implemented')
  }
   ...
   */
  Struct.prototype.toFastBuffer = function (/* ...rest*/) {
  ...
  Struct.prototype.fromFastHex = function (hex /* , ...rest*/) {
    let rest = Array.prototype.slice.call(arguments, 1)
    let buf
    try {
      buf = new Buffer(hex, 'hex')
  ...
  Struct.prototype.toFastHex = function (/* ...rest*/) {
