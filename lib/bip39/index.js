...
"use strict";
let dependencies = {
  Constants: require('../constants').Default.BIP39,
  Hash: require('../hash'),
  KDF: require('../kdf'),
...
let BIP39 = injector(inject, dependencies, {
  Wordlist: require('./' + require('../constants').Default.BIP39.language)
});
BIP39.en = injector(inject, dependencies, {
  Constants: {language: 'en'},
  Wordlist: require('./en')
});
BIP39.jp = injector(inject, dependencies, {
