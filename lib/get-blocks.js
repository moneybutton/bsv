...
let inject = function (deps) {
  ...
  class GetBlocks extends Struct {
    constructor (versionBytesNum, hashBufsVi, hashBufs, stopHashBuf) {
      super()
      this.initialize()
      this.fromObject({versionBytesNum, hashBufsVi, hashBufs, stopHashBuf})
    }

    initialize () {
      this.versionBytesNum = Constants.Msg.versionBytesNum
    }
