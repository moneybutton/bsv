...
let Constants = require('./constants').Default.Bip32
...
class Bip32 extends Struct {
  ...
  fromRandom () {
    this.versionBytesNum = Constants.privKey
    this.depth = 0x00
  ...
  fromBuffer (buf) {
    ...
    if (isPrivate && keyBytes[0] === 0) {
      this.privKey = new PrivKey().fromBn(
  ...
  toPublic () {
    ...
    bip32.versionBytesNum = Constants.pubKey
  ...
  isPrivate () {
    return this.versionBytesNum === Constants.privKey
  }
}
