...
let inject = function (deps) {
  ...
  class Bip32 extends Struct {
    constructor (versionBytesNum, depth, parentFingerPrint, childIndex, chainCode, privKey, pubKey) {
      super()
      this.fromObject({versionBytesNum, depth, parentFingerPrint, childIndex, chainCode, privKey, pubKey})
    }
    ...
    asyncToString () {
      return asink(function * () {
        let workersResult = yield Workers.asyncObjectMethod(this, 'toString', [])
