 ...
 *
 * let mnemonic = BIP39('en').fromRandom().toMnemonic();
 *
 * or from a known mnemonic:
 *
 * let seed = BIP39('en').fromMnemonic(mnemonic).toSeed();
 */
"use strict";
...
let BIP39 = function(wordlist) {
  ...
  if (typeof wordlist !== 'undefined')
    this.fromObject({wordlist: wordlist});
};

module.exports = BIP39;

BIP39.prototype.fromObject = function(obj) {
