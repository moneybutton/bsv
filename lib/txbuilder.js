...
Txbuilder.prototype.set = function(obj) {
  ...
  this.prevtxoutsmap = obj.prevtxoutsmap || this.prevtxoutsmap;
  return this;
};

Txbuilder.prototype.addToAddress = function(valuebn, addr) {
...
Txbuilder.prototype.verifytxnin = function(nin, flags) {
  ...
  var txidbuf = BufR(txin.txhashbuf).readReverse();
  var txidhex = txidbuf.toString('hex');
  var mapid = txidhex + ":" + txoutnum;
  var scriptPubkey = this.prevtxoutsmap[mapid].script;
  var interp = Interp()
