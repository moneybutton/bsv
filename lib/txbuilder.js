...
let inject = function (deps) {
  ...
  let Txbuilder = function Txbuilder (tx, txins, txouts, utxoutmap, changeAddress, feePerKBNum, nlocktime) {
    if (!(this instanceof Txbuilder)) {
      return new Txbuilder(tx, txins, txouts, utxoutmap, changeAddress, feePerKBNum, nlocktime)
    }
    this.initialize()
    this.fromObject({tx, txins, txouts, utxoutmap, changeAddress, feePerKBNum, nlocktime})
  }
