 ...
 */
Txbuilder.prototype.addTo = function(valuebn, addr) {
...
Txbuilder.prototype.build = function() {
  ...
  if (changeamount.gt(0)) {
    var txout = Txbuilder().addTo(changeamount, this.changeaddr).toTxouts[0];
    this.tx.addTxout(txout);
  }
...
/**
 * sign ith input with optional keypair (will use keypair in txoutmap if not
 * present here)
 */
