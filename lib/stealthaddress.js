...
let StealthAddress = function StealthAddress(addrstr) {
...
StealthAddress.prototype.fromObject = function(obj) {
...
StealthAddress.prototype.toBuffer = function(networkstr) {
  ...
  if (networkstr === 'testnet')
    version = StealthAddress.testver;
  else
    version = StealthAddress.mainver;
  let bw = new BW();
