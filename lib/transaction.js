...
Transaction.prototype.sighash = function(nhashtype, nin, subscript) {
  var txcopy = Transaction(this.toBuffer());
  ...
  var hashtypebuf = new Buffer(4);
  hashtypebuf.writeInt32LE(nhashtype, 0);
  var buf = BufferWriter().write(txcopy.toBuffer()).write(hashtypebuf).concat();
...
Transaction.prototype.addTxin = function(txin) {
  this.txins.push(txin);
  this.txinsvi = Varint(this.txinsvi.toNumber() + 1);
  return this;
};

Transaction.prototype.addTxout = function(txout) {
