...
let inject = function (deps) {
  ...
  class TxBuilder extends Struct {
    constructor (tx, txIns, txOuts, uTxOutMap, changeScript, feePerKbNum, nLockTime, versionBytesNum) {
      super()
      this.initialize()
      this.fromObject({tx, txIns, txOuts, uTxOutMap, changeScript, feePerKbNum, nLockTime, versionBytesNum})
    }
