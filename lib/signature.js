 ...
 * appended, and the final one is Compact, which is used by Message.
 */
...
Signature.prototype.fromDER = function(buf, strict) {
...
Signature.prototype.fromTxFormat = function(buf) {
