...
MultiSigScriptHashInput.prototype._estimateSize = function () {
  ...
  // OP_2 <pub keys> OP_3 OP_CHECKMULTISIG
  var redeemScriptSize = 1 + pubKeysSize + 2
  // OP_0 <sigs> <=OP_PUSHDATA2 <length> <redeemScript>
  var scriptLength = 1 + sigsSize + (redeemScriptSize > 255 ? 3 : 2) + redeemScriptSize
  // out point + <script> + sequence
  return 36 + Varint(scriptLength).toBuffer().length + scriptLength + 4
}
