...
PublicKeyHashInput.prototype.getSignatures = function (transaction, privateKey, index, sigtype, hashData) {
  ...
  hashData = hashData || Hash.sha256ripemd160(PublicKey.fromPrivateKey(privateKey).toBuffer())
...
PublicKeyHashInput.SCRIPT_MAX_SIZE = 149 // sigsize (1 + 72) + pubkey (1 + 33) + txid (32) + vout (4) + seqnum (4) + script (2)
