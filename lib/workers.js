...
let dependencies = {
  ...
  WorkersCmd: require('./workerscmd'),
  WorkersResult: require('./workersresult'),
...
let inject = function (deps) {
  ...
  Workers.prototype.onStdoutData = function (buf) {
    let workersResult = WorkersResult().fromFastBuffer(buf)
  ...
  Workers.prototype.asyncObjectMethod = function (obj, methodname, args, id) {
    ...
    let workersCmd = WorkersCmd().fromObjectMethod(obj, methodname, args, id)
  ...
  Workers.asyncObjectMethod = function (obj, methodname, args, id) {
    if (!globalWorkers) {
      globalWorkers = Workers().spawn()
    }
    return globalWorkers.asyncObjectMethod.apply(globalWorkers, arguments)
  }
  ...
  Workers.prototype.asyncClassMethod = function (classname, methodname, args, id) {
    ...
    id = id !== undefined ? id : ++this.lastid
    let workersCmd = WorkersCmd().fromClassMethod(classname, methodname, args, id)
    let buf = workersCmd.toFastBuffer()
    return new Promise(function (resolve, reject) {
      this.sendBuffer(buf)
      this.promisemap.set(id, {
  ...
  Workers.asyncClassMethod = function (obj, methodname, args, id) {
    ...
    return globalWorkers.asyncClassMethod.apply(globalWorkers, arguments)
  }
