 ...
 */
Txverifier.prototype.verifytx = function(flags) {
 ...
 */
Txverifier.prototype.checktxstr = function() {
 ...
 */
Txverifier.prototype.verifytxstr = function(flags) {
  for (var i = 0; i < this.tx.txins.length; i++) {
 ...
 */
Txverifier.prototype.verifytxnin = function(nin, flags) {
