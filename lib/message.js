 ...
 * ==============
 *
 * "Message" just refers to a standard way of signing and verifying an
 * arbitrary message. Confusingly, it has nothing to do with bitcoin's p2p
 * protocol. The standard way to do this involves using a "Bitcoin Signed
 * Message:\n" prefix, which this code does. You are probably interested in the
 * static Message.sign( ... ) and Message.verify( ... ) functions, which deal
 * with a base64 string representing the compressed format of a signature.
 * That's just how the standard works.
 */
