 ...
 * arbitrary message. The standard way to do this involves using a "Bitcoin
 * Signed Message:\n" prefix, which this code does. You are probably interested
 * in the static Message.sign( ... ) and Message.verify( ... ) functions, which
 * deal with a base64 string representing the compressed format of a signature.
