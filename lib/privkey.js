...
function inject(deps) {
  ...
  Privkey.prototype = Object.create(deps.Struct.prototype);
...
let Privkey = injector(inject, dependencies);
Privkey.Mainnet = injector(inject, dependencies, {
  Constants: require('./constants').Mainnet.Privkey
});
Privkey.Testnet = injector(inject, dependencies, {
