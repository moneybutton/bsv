...
function inject(deps) {
  ...
  function Connection(opts, netchannel, buffers, msgassembler, awaits) {
    if (!(this instanceof Connection))
      return new Connection(opts, netchannel, buffers, msgassembler, awaits);
    this.initialize();
    this.fromObject({
      opts: opts,
  ...
  Connection.prototype.monitor = function() {
    if (!this.buffers) {
      this.buffers = this.netchannel.awaitBuffers();
    }
  ...
  Connection.prototype.send = function(msg) {
    return this.netchannel.send(msg.toBuffer());
  };

  Connection.prototype.close = function() {
    return this.netchannel.close();
  };
