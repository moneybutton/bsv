...
For more information refer to the [bsv-message](https://github.com/bitpay/bsv-message) github repo.
...
```bash
npm install bsv-message --save
```

For client-side projects:

```bash
bower install bsv-message --save
```
