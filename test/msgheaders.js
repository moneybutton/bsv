...
let MsgHeaders = require('../lib/msgheaders')
...
describe('MsgHeaders', function () {
  ...
  describe('#fromBlockheaders', function () {
    it('should make a msg from blockheaders', function () {
      let msgheaders = MsgHeaders().fromBlockheaders([blockheader])
  ...
  describe('#toBlockheaders', function () {
    it('should make a msg from blockheaders', function () {
      let msgheaders = MsgHeaders().fromBlockheaders([blockheader, blockheader, blockheader])
