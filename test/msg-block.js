...
let MsgBlock = require('../lib/msg-block')
let asink = require('asink')
let should = require('chai').should()

describe('MsgBlock', function () {
  ...
  it('should exist', function () {
    let msgblock = new MsgBlock()
    should.exist(MsgBlock)
    should.exist(msgblock)
  })
  ...
  describe('#fromBlock', function () {
    it('should convert a block into a msgblock', function () {
      ...
      let msgblock = new MsgBlock().fromBlock(block)
  ...
  describe('#asyncFromBlock', function () {
    it('should convert a block into a msgblock', function () {
      return asink(function * () {
        let block = new Block().fromHex(blockhex)
        let msgblock = yield new MsgBlock().asyncFromBlock(block)
        msgblock.isValid().should.equal(true)
      }, this)
    })
  })
  ...
  describe('#isValid', function () {
    it('should know this msgblock is or is not valid', function () {
      ...
      msgblock.isValid().should.equal(false)
    })
  })
})
