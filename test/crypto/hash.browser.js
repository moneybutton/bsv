...
describe('Hash', function () {
  if (process.browser) {
    ...
    describe('#sha256', function () {
      ...
      it('fails when the input is not a buffer', async function () {
        const hash = await Hash.sha256.bind(Hash, str)
        hash.should.throw('Invalid Argument')
      })
    })

    describe('#sha256hmac', function () {
      it('computes this known big key correctly', async function () {
        var key = Buffer.from('b613679a0814d9ec772f95d778c35fc5ff1697c493715653c6c712144292c5ad' +
          'b613679a0814d9ec772f95d778c35fc5ff1697c493715653c6c712144292c5ad' +
          'b613679a0814d9ec772f95d778c35fc5ff1697c493715653c6c712144292c5ad' +
          'b613679a0814d9ec772f95d778c35fc5ff1697c493715653c6c712144292c5ad')
        var data = Buffer.from('')
        const hash = await Hash.sha256hmac(data, key).toString('hex')
        hash.should.equal('fb1f87218671f1c0c4593a88498e02b6dfe8afd814c1729e89a1f1f6600faa23')
      })

      it('computes this known empty test vector correctly', async function () {
        var key = Buffer.from('')
        var data = Buffer.from('')
        const hash = Hash.sha256hmac(data, key).toString('hex')
        hash.should.equal('b613679a0814d9ec772f95d778c35fc5ff1697c493715653c6c712144292c5ad')
      })

      it('computes this known non-empty test vector correctly', async function () {
        var key = Buffer.from('key')
        var data = Buffer.from('The quick brown fox jumps over the lazy dog')
        const hash = Hash.sha256hmac(data, key).toString('hex')
        hash.should.equal('f7bc83f430538424b13298e6aa6fb143ef4d59a14946175997479dbc2d1a3cd8')
      })
    })
    ...
    describe('#sha256sha256', function () {
      ...
      it('fails when the input is not a buffer', async function () {
        const hash = await Hash.sha256sha256.bind(Hash, str)
        hash.should.throw('Invalid Argument')
      })
    })
    ...
    describe('#sha256ripemd160', function () {
      it('calculates the hash of this buffer correctly', async function () {
        var hash = await Hash.sha256ripemd160(buf)
        hash.toString('hex').should.equal('7322e2bd8535e476c092934e16a6169ca9b707ec')
      })

      it('fails when the input is not a buffer', async function () {
        const hash = await Hash.sha256ripemd160.bind(Hash, str)
        hash.should.throw('Invalid Argument')
      })
    })
    ...
    describe('#ripemd160', function () {
      it('calculates the hash of this buffer correctly', async function () {
        var hash = await Hash.ripemd160(buf)
        hash.toString('hex').should.equal('fa0f4565ff776fee0034c713cbf48b5ec06b7f5c')
      })

      it('fails when the input is not a buffer', async function () {
        const hash = await Hash.ripemd160.bind(Hash, str)
        hash.should.throw('Invalid Argument')
      })
    })
    ...
    describe('#sha512', function () {
      it('calculates the hash of this buffer correctly', async function () {
        var hash = await Hash.sha512(buf)
        hash.toString('hex')
      ...
      it('fails when the input is not a buffer', async function () {
        const hash = await Hash.sha512.bind(Hash, str)
        hash.should.throw('Invalid Argument')
      })
    })

    describe('#sha512hmac', function () {
      it('calculates this known empty test vector correctly', async function () {
        ...
        const hash = Hash.sha512hmac(Buffer.from([]), Buffer.from([])).toString('hex')
        hash.should.equal(hex)
      })

      it('calculates this known non-empty test vector correctly', async function () {
        ...
        const hash = await Hash.sha512hmac(data, key).toString('hex')
        hash.should.equal(hex)
      })
    })
  }
