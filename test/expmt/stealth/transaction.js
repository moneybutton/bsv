...
var STransaction = require('../../../lib/expmt/stealth/transaction');
var Transaction = require('../../../lib/transaction');
var Varint = require('../../../lib/varint');

describe('STransaction', function() {
  ...
  it('should make a new STransaction', function() {
    var stx = new STransaction();
    should.exist(stx);
    stx = STransaction();
    should.exist(stx);
  });
  ...
  describe('#isForMe', function() {
    ...
    it('should return false for this known tx and random stealthkey', function() {
      ...
      var stx = STransaction().set({sk: sk, tx: tx});
  ...
  describe('#notMine', function() {
    ...
    it('should return true for this known tx and random stealthkey', function() {
      var sk = SKey().fromRandom();
      var stx = STransaction().set({sk: sk, tx: tx});
      stx.notMine().should.equal("STransaction not mine");
    });
  ...
  describe('#notStealth', function() {
    ...
    it('should know this is a stealth tx', function() {
      var stx = STransaction().set({tx: tx});
    ...
    it('should know this is not a stealth tx', function() {
      ...
      var stx = STransaction().set({tx: tx2});
  ...
  describe('@parseOpReturnData', function() {
    ...
    var parsed = STransaction.parseOpReturnData(buf);
